...
## we perform the factor fashion training (hidden factors as variables), and by the way impute the missing ceils in the tensor
## train and test
...
with tf.device("/cpu:0"):
	...
	##
	lr = tf.constant(0.00000000006, name='learning_rate')
